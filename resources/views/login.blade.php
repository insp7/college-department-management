...
<div class="content">
    ...
    <form class="login-form" action="{{ route('login') }}" method="POST">
        ...
        <div class="form-group">
            ...
            <input class="form-control form-control-solid placeholder-no-fix" id="email" type="text" autocomplete="off"
                   placeholder="Enter your phone number : " name="phone_number"/></div>
        <div class="form-group">
            <label class="control-label visible-ie8 visible-ie9">Password</label>
            <input class="form-control form-control-solid placeholder-no-fix" id="password" type="password" autocomplete="off"
                   placeholder="Enter your password" name="password"/></div>
        <div class="form-actions text-center">
            <button type="submit" id="login-button" class="btn green uppercase" name="submit">Login</button>

...
@section('page-content')
    <div class="page-bar">
        ...
        <ul class="page-breadcrumb">
            ...
            <li>
                <span>Manage Dispatched Orders</span>
            </li>
        </ul>
        ...
        <!-- BEGIN PAGE TITLE-->
        <h3 class="page-title"> Manage Dispatched Orders
                ...
                <div class="portlet light portlet-fit bordered">
                    <div class="portlet-title">
                        <div class="caption">
                            ...
                            <span class="caption-subject font-blue bold uppercase">Dispatched Orders</span>
                        </div>
                    </div>

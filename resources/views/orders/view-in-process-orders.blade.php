...
@section('page-content')
    ...
    <!-- END OF ERRORS SECTION -->
        ...
        <div class="clearfix">
            <br>
            <a href="/invoice/{{$id}}/create" class="btn blue pull-right" > <i class="fa fa-truck"></i> Dispatch Products</a>
            <button class="btn blue margin-right-10 pull-right" data-toggle="modal" data-target="#completedOrderModal"> <i class="fa fa-check"></i> Order Completed</button>
            <button class="btn blue margin-right-10 pull-right" data-toggle="modal" data-target="#reassignOrderModal"> <i class="fa fa-refresh"></i> Reassign Order</button>
            <button data-toggle="modal" data-target="#cancelOrderModal" class="btn red pull-right margin-right-10"> <i class="fa fa-trash"></i> Cancel Order</button>
        </div>
    ...
    <!-- CANCEL ORDER MODAL -->
    <div class="modal fade" tabindex="-1" role="dialog" id="reassignOrderModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Reassign Order</h4>
                </div>

                <div class="modal-body">
                    <div class="row">
                        <form action="/order/{{$id}}/update/placed" id="delete_form" method="POST">
                            @csrf
                            <div class="form-body">
                                <!-- START OF MODAL BODY -->
                                <div class="container margin-bottom-10">
                                    <label>Are you sure you want to reassign the current order ?</label>
                                </div>
                                <!-- MODAL FOOTER -->
                                <div class="modal-footer">
                                    <button type="button" class="btn default" data-dismiss="modal">Cancel</button>
    ...
    <!-- CANCEL ORDER MODAL -->
    <div class="modal fade" tabindex="-1" role="dialog" id="completedOrderModal">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <h4 class="modal-title">Mark order as completed</h4>
                </div>
                    ...
                    <div class="row">
                        <form action="/order/{{$id}}" id="delete_form" method="POST">
                            ...
                            <div class="form-body">
                                <!-- START OF MODAL BODY -->
                                <div class="container margin-bottom-10">
                                    <label>Are you sure you want to mark the order as completed</label>
                                </div>
                                <!-- MODAL FOOTER -->
                                <div class="modal-footer">
                                    <button type="button" class="btn default" data-dismiss="modal">Cancel</button>
...
@section ('custom-script')
    ...
    <script>
        ...
        let oTable = invoiceTable.DataTable({
            processing: true,
            serverSide: true,
        ...
        setInterval(() => oTable.ajax.reload(null, false), 5000);

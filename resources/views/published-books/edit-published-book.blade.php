                    ...
                    <form method="post" enctype="multipart/form-data" action="/published-books/{{ $published_book->id }}">
                        ...
                        <div class="input-group input-group-merge @error('book_name') has-danger @enderror">
                            <div class="input-group-prepend"> <span class="input-group-text"> <i
                                        class="fa fa-newspaper"></i> </span> </div> <input value="{{ $published_book->book_name }}"
                      ...
                      <div class="form-group">
                        <div class="input-group input-group-merge @error('publisher_name') has-danger @enderror">
                            <div class="input-group-prepend"> <span class="input-group-text"> <i
                                        class="fa fa-newspaper"></i> </span> </div> <input value="{{ $published_book->publisher_name }}"
                        ...
                        @enderror
                                ...
                                <div class="form-group">
                                    <div class="input-group @error('date') has-danger @enderror">
                                        ...
                                        <input type="text" value="{{ $published_book->date }}" required name="date"  placeholder="Date of publication" data-date-format="yyyy/mm/dd" class="form-control datepicker @error('date') is-invalid @enderror">
                                    </div>
                                    @error('date')
                                    <div class="invalid-feedback" style="display: block">{{ $message }}</div>
                                    @enderror

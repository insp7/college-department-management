        ...
        <form action="/retailer/{{$retailer->id}}" , method="POST">
            ...
            <div class="row">
                <div class="form-group col-md-6">
                    ...
                    <input value="{{$retailer->user->name}}" type="text" name="name" id="name" class="form-control"
                           placeholder="Enter the name" disabled/>
                </div>

                <div class="form-group col-md-6">
                    <label for="weight">Email *</label>
                    <input value="{{$retailer->user->email}}" type="email" name="email" id="email" class="form-control"
                           placeholder="Enter email id"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="phone">Phone Number *</label>
                    <input value="{{$retailer->user->phone_number}}" type="tel" name="phone_number" id="phone"
                           class="form-control" placeholder="Enter the phone number"/>
                </div>

                <div class="form-group col-md-6">
                    <label for="phone">Company Name *</label>
                    <input value="{{$retailer->company}}" type="text" name="company" id="company" class="form-control"
                ...
                <div class="form-group col-md-6">
                    ...
                    <textarea name="address" id="address" class="form-control"
                              rows="3">{{$retailer->address}}</textarea>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="distributor_id" id="distributor" class="form-control">
                        <option></option>
                        <option selected
                                value="{{$retailer->distributor->id}}">{{$retailer->distributor->user->name}}</option>
                    </select>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <select name="subdistributor_id" id="subdistributor" class="form-control">
                        ...
                        @if($retailer->subdistributor)
                            ...
                            <option selected
                                    value="{{$retailer->subdistributor->id}}">{{$retailer->subdistributor->user->name}}</option>
                        @endif
                    </select>
                </div>
                ...
                <div class="form-group col-md-6">
                    ...
                    <input value="{{ $retailer->gstNo() }}" type="text" name="gst_no" id="company" class="form-control"
                ...
                <div class="form-group col-md-6">
                    ...
                    <input type="text" name="transport" id="transport" class="form-control"
                           placeholder="Enter the transport : " value="{{ $retailer->transport }}">
                </div>

                <div class="form-group col-md-6">
                    <label for="term">Term *</label>
                    <input type="text" name="term" id="term" class="form-control" placeholder="Enter the term : " value="{{ $retailer->term }}">
                </div>
            </div>
